...
const SigninIntern = () => {
    ...
    useEffect(() => {
            ...
            const fetchProfile = async () => {
                try {
                    const response = await axios.get(`http://localhost:4000/api/v1/getall-hr`,);
      ...
      setLoading(true);
       try {
        if( formValues.name ==="" || formValues.DOB === "" || formValues.hrID === ""){
          ...
          const response = await axios.post(`http://localhost:4000/api/v1/sign-up-intern`,formValues);
