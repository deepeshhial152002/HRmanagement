...
const ProfileIntern = () => {
  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      try {
        const response = await axios.get(`http://localhost:4000/api/v1/getIntern-info`, { headers });
    ...
    const fetchUrlData = async () => {
      try {
        const response = await axios.get(`http://localhost:4000/v1/url-info-intern`, { headers });
